...
namespace DesiTadkaRestaurant.Models
{
    public class Details : DropCreateDatabaseAlways<DesiTadka>
    {
        protected override void Seed(DesiTadka context)
        {
            ...
            new List<MenuItem>
            {
                new MenuItem {MenuName = "Dokla And Green Chatni",description="Dokla is made from rice flour,", Price=5.99M, MenuType = types.Single(g => g.Name == "Appetizer"), FoodUrl = "/Assets/images/Appetizer/1.jpg" },
